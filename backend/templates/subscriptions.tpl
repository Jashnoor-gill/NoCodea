...
<div data-v-component-product-subscriptions>
    <div data-v-subscription>
        <h3 data-v-subscription-name>Subscription Name</h3>
        <div data-v-subscription-description>Subscription Description</div>
        <div data-v-subscription-price>Price</div>
        <div data-v-subscription-duration>Duration</div>
    </div>
</div> 