...
<div data-v-component-product-vendors>
    <div data-v-vendor>
        <h3 data-v-vendor-name>Vendor Name</h3>
        <div data-v-vendor-content>Vendor Description</div>
        <img data-v-vendor-image src="#" alt="">
        <input type="checkbox" data-vendor-vendor_id="">
    </div>
</div> 