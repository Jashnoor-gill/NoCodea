...
if($breadcrumb && is_array($breadcrumb['breadcrumb'])) {
	foreach ($breadcrumb['breadcrumb'] as $index => $breadcrumb_item) {$index++;?>
		
		@item [data-v-breadcrumb-item-*]|innerText = $breadcrumb_item['@@__data-v-breadcrumb-item-(*)__@@']
		
		@item a[data-v-breadcrumb-item-*]|href = $breadcrumb_item['@@__data-v-breadcrumb-item-(*)__@@']
...
<nav data-v-component-breadcrumb aria-label="breadcrumb">
  <ol class="breadcrumb">
    <li class="breadcrumb-item" data-v-breadcrumb-item>
        <a href="#" data-v-breadcrumb-item-url>Home</a>
        <span data-v-breadcrumb-item-name>Home</span>
    </li>
  </ol>
</nav> 