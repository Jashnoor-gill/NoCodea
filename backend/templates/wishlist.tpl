...
<div data-v-component-user-wishlist>
    <div data-v-wishlist-header>
        <h2 data-v-wishlist-category>Wishlist Category</h2>
        <span data-v-wishlist-count>0</span>
        <span data-v-wishlist-manufacturer>Manufacturer</span>
    </div>
    <div data-v-product>
        <div data-v-product-images>
            <img data-v-product-image src="#" alt="" data-v-product-alt>
            <a data-v-product-url href="#">
                <h3 data-v-product-name>Product Name</h3>
            </a>
        </div>
        <div data-v-product-content>Product Description</div>
